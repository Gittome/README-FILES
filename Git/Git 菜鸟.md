...
本站也提供来Git快速入门版本，你可以点击 [Git简明指南](http://www.runoob.com/manual/git-guide/) 查看。
...
- 5、[互联网组织的未来：剖析GitHub员工的任性之源](http://www.runoob.com/w3cnote/internet-organization-github.html)
...
比如说，我们想为我们的 runoob 项目发布一个"1.0"版本。 我们可以用 git tag -a v1.0 命令给最新一次提交打（HEAD）"v1.0"的标签。
